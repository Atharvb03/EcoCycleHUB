...
function RecycleRepairFinder() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-gray-950 dark:via-emerald-950 dark:to-slate-950 p-10">
      {/* Animated Background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          {locations.filter(l => parseFloat(l.distanceNum) <= distanceFilter).map((loc, index) => (
            <div 
              key={loc.id} 
              className="group bg-white/80 dark:bg-gray-900/85 dark:bg-gray-900/85 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800
      ...
      {qrCenter && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4"
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center"
            ...
            <div className="flex justify-center mb-5 p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-md w-full transform animate-scale-in overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  onClick={closeModal}
                  className="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-red-500 hover:text-white 
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 
