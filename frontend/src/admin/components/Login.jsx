...
const Field = ({ icon, children }) => (
  <div className="flex items-center gap-2 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2 bg-white dark:bg-gray-900 focus-within:ring-2 focus-within:ring-gray-400 transition">
...
function Login({ setToken }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center w-full bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-gray-950 dark:via-emerald-950 dark:to-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/80 dark:bg-gray-900/85 backdrop-blur-sm shadow-2xl rounded-3xl px-10 py-10 max-w-md w-full border border-green-100 dark:border-emerald-900/60">
        <div className="text-center mb-8">
          <a href="/" className="flex items-center gap-1 text-xs text-gray-400 dark:text-gray-100 hover:text-green-600 transition mb-4 justify-start">
            ← Back to Homepage
          </a>
          ...
          <p className="text-gray-500 dark:text-gray-100 text-sm mt-1">EcoCycleHub Management</p>
        </div>
