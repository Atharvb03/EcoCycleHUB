...
const ProductItem = ({id,image,name,price}) => {
  ...
  return (
    <Link onClick={()=>scrollTo(0,0)} to={`/product/${id}`}>
      <div className='group relative overflow-hidden rounded-2xl bg-white border border-gray-100 shadow-lg
        ...
        <div className='p-4 relative z-10'>
          <p className='text-sm text-gray-700 font-medium mb-2 line-clamp-2 group-hover:text-green-600 
